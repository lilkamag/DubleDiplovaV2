...
namespace WindowsFormsApp19
{
    public partial class Form3 : Form
    {
        ...
        private void pictureBox23_Click(object sender, EventArgs e)
        {
            ...
            string Line = File.ReadAllText("password.sql", Encoding.UTF8);
            richTextBox1.Text = Line;

            if (richTextBox1.Text.Contains(textBox14.Text))
            {
                string str11 = "";
                ...
                int index = richTextBox1.Text.IndexOf(textBox14.Text);  
                string str123 = richTextBox1.Text.Substring(0, index); 
                string str232 = richTextBox1.Text.Substring((index + textBox14.TextLength), (richTextBox1.TextLength - (index + textBox14.TextLength))); 
                string result = str123 + textBox3.Text + str232; 
                richTextBox1.Clear(); 
            ...
            else 
            {
                ...
                textBox6.Clear();
                textBox5.Clear();
                MessageBox.Show("Старый пароль не был найден!", "Смена пароля");
            }

            if (textBox14.TextLength == 0 || textBox3.TextLength == 0 || textBox4.TextLength == 0 || textBox5.TextLength == 0)
            {
                textBox14.Clear();
                textBox1.Clear();
                textBox3.Clear();
                ...
                textBox6.Clear();
                textBox5.Clear();
                MessageBox.Show("Заполните все поля!", "Смена пароля");
            }
            else if (textBox5.Text != label7.Text)
            {
                ...
                textBox6.Clear();
                textBox5.Clear();
                MessageBox.Show("Не верно введён код с картинки по пробуйте ещё раз!", "Смена пароля");
                Random hf1 = new Random();
                label7.Text = hf1.Next(10000, 999999).ToString();
            }
            else if (textBox3.Text != textBox4.Text)
            {
                ...
                textBox6.Clear();
                textBox5.Clear();
                MessageBox.Show("Пароли не совпадают!", "Смена пароля");
            }
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Пароль скопирован в буфер обмена!", "Смена пароля");
        }
        ...
        {
            ToolTip t = new ToolTip();
            t.SetToolTip(textBox7, "Поля для ввода нового пароля пароля.");
        }

        private void textBox6_MouseEnter(object sender, EventArgs e)
        {
            ToolTip t = new ToolTip();
            t.SetToolTip(textBox6, "Поля для ввода повторите пароль.");
        }

        private void textBox4_MouseEnter(object sender, EventArgs e)
        {
            ToolTip t = new ToolTip();
            t.SetToolTip(textBox4, "Поля для ввода повторите пароль.");
        }

        private void textBox3_MouseEnter(object sender, EventArgs e)
        {
            ToolTip t = new ToolTip();
            t.SetToolTip(textBox3, "Поля для ввода нового пароля.");
        }
        ...
        {
            ToolTip t = new ToolTip();
            t.SetToolTip(pictureBox23, "Нажмите на кнопку для того чтобы сменить пароль от вашей учётной записи.");
        }
        ...
        private void textBox5_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show("Ввод букв и символов в поле капча запрещено, в поле капча можно писать только цыфрами!", "Смена пароля");
                e.Handled = true;
            }
        }
